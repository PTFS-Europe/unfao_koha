...
# -- generated at [Fri Jan 13 15:44:50 2012]
# -- generated from file:///home/cc/bloody_agrovoc/ACSWWebService.WSDL
my %methods = (
getAgrovocDatabaseNames => {
    endpoint => 'http://agrovoc.mimos.my/ACSWWebservice/services/ACSWWebService',
    soapaction => '',
    namespace => 'http://webservice.acsw.fao.org',
    parameters => [
    ], # end parameters
  }, # end getAgrovocDatabaseNames
getConceptObject => {
    endpoint => 'http://agrovoc.mimos.my/ACSWWebservice/services/ACSWWebService',
    soapaction => '',
    namespace => 'http://webservice.acsw.fao.org',
...
getRejectedConcepts => {
    ...
    parameters => [
      ...
      SOAP::Data->new(name => 'start', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'end', type => 'xsd:string', attr => {}),
      SOAP::Data->new(name => 'format', type => 'xsd:string', attr => {}),
    ], # end parameters
...
sub _call {
  ...
  $self->serializer->register_ns("http://webservice.acsw.fao.org","intf");
  $self->serializer->register_ns("http://webservice.acsw.fao.org","impl");
